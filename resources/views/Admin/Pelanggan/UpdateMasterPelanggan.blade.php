...
<div class="container">
  <div class="card">
    <div class="card-header bg-primary text-white">UPDATE DATA PELANGGAN</div>
    <div class="card-body">
<form action='/Master/Pelanggan/updatepelanggan' method='post'>
{{ csrf_field() }}
...
<input type="hidden" name='id' value='{{$p->id_pelanggan }}'>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control"  name='nik' value='{{$p->nik }}' required>
  </div>
  <div class="form-group">
