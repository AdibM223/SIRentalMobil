...
<body class="align">
  ...
  @if(session('error'))
            ...
            @endif
  <form action="{{ route('actionloginPelanggan') }}" method="POST" class="form login">
    @csrf
    <div >
    <img src="https://indorentalmobil.com/wp-content/uploads/2021/08/INDO-RENTAL-LOGO-1.jpeg" height="120" width="240" alt="usp">
    </div>
