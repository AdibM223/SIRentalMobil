...
<div class="wrapper">
  ...
  <aside class="main-sidebar text-sm sidebar-light-teal elevation-4">
    ...
    <img src="https://indorentalmobil.com/wp-content/uploads/2021/08/INDO-RENTAL-LOGO-1.jpeg" height="120" width="220" alt="rental_mobil">
    </a>
        ...
        <ul class="nav nav-pills  nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">     
          ...
          <li class="nav-item m">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/Admin/Tarif" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Tarif</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/Admin/LaporanTransaksi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Transaksi Sewa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/Admin/LaporanMobil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Ketersediaan Mobil</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ route('actionlogoutAdmin') }}" class="nav-link">
